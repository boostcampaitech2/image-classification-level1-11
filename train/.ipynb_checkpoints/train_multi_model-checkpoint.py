...
def train(data_dir, model_dir, args):
    ...
    for task in tasks:
        ...
        # -- dataset
        dataset_module = getattr(import_module("dataset"), args.dataset + '_' + task)   # ex) args.dataset : DJ_SeparatedDataset
                                                                                        # -> DJ_SeparatedDataset_Mask, DJ_SeparatedDataset_Gender, DJ_SeparatedDataset_Age
